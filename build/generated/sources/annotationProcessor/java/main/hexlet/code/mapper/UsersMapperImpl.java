...
@Generated(
    ...
    date = "2024-09-24T11:58:28+0300",
    comments = "version: 1.5.5.Final, compiler: IncrementalProcessingEnvironment from gradle-language-java-8.7.jar, environment: Java 21.0.4 (Amazon.com Inc.)"
)
@Component
public class UsersMapperImpl extends UsersMapper {
    ...
    public void update(UserUpdateDTO updateDTO, User user) {
        ...
        user.setPasswordDigest( mapPassword(updateDTO.getPassword()) );
    }
}
